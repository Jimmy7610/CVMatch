...
1. Starta Ollama och ladda en språkmodell, t.ex:
   ...
   \`\`\`
2. Välj "Ollama (AI, lokalt)" under _Metod_ i CV-anpassaren.
3. Se till att \`http://localhost:11434\` anges i gränssnittet.

_Om Ollama inte svarar eller misslyckas med validering, faller applikationen automatiskt tillbaka till Standard-motorn._
